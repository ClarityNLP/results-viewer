        ...
        <div className="row">
          <div className="col">
            <h3>
              <small>
                <Button
                  className="btn btn-light ArrowButtons"
                  onClick={this.props.resetJobsList}
                >
                  <FaArrowLeft />
                </Button>
              </small>
              <span className="PhenotypeTitle">
                {this.props.job.phenotype_name}
              </span>
              <span className="PatientCount">{this.state.patient_count}</span>
              <small className="float-sm-right ToggleButtons">
                <ButtonGroup>
                  <Button
                    onClick={() => this.onRadioBtnClick(EXPLORE)}
                    active={this.state.mode_selected === EXPLORE}
                  >
                    Explore
                  </Button>
                  <Button
                    onClick={() => this.onRadioBtnClick(INTERMEDIATE)}
                    active={this.state.mode_selected === INTERMEDIATE}
                  >
                    Features
                  </Button>
                  <Button
                    onClick={() => this.onRadioBtnClick(ALL)}
                    active={this.state.mode_selected === ALL}
                  >
                    Cohort
                  </Button>
                </ButtonGroup>
