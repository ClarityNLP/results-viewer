      ...
      <React.Fragment>
        <div className='columns'>
          <div className='column is-1'>
            <button className='button' onClick={this.props.resetJobsList}>
              <FaArrowLeft />
            </button>
          </div>
              ...
              <div className='field has-addons'>
                <div className='control'>
                  <button
                    ...
                    disabled={this.state.mode_selected === EXPLORE}
                  >
                    Explore
                  </button>
                </div>
                <div className='control'>
                  <button
                    ...
                    disabled={this.state.mode_selected === INTERMEDIATE}
                  >
                    Features
                  </button>
                </div>
                <div className='control'>
                  <button
                    ...
                    disabled={this.state.mode_selected === ALL}
                  >
                    Cohort
                  </button>
                </div>
