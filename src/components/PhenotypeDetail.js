      ...
      <div>
        {selected_result_index > -1 ? (
          <div className="PhenotypeDetailMain">
            <div>
              <span className="h4"> {selected_result.nlpql_feature} </span>
            ...
            {this.state.successAlert === true ? (
              <Alert color="success" toggle={this.onDismiss}>
                <font size="3">Thank you for submitting feedback.</font>
              </Alert>
            ) : (
              <span />
            )}
            {this.state.failureAlert === true ? (
              <Alert color="danger" toggle={this.onDismiss}>
                <font size="3">Could not submit feedback. Contact Admin.</font>
              </Alert>
            ) : (
              <span />
            )}
